...
if($output_to_browser == 1){
        set_time_limit(0); //Limit script to run no longer than 300 seconds if launched via the web browser
        $lb = "<br>\n"; //Line break
